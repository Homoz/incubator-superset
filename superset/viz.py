...
class ChinaMapViz(BaseViz):
    ...
    def query_obj(self):
        ...
        form_data = self.form_data
        #  logging.info(self.json_dumps(query))
        #  query['columns'] = [form_data.get('groupby'), form_data.get('metric')]
        #  query['groupby'] = form_data.get('groupby')
        #  query['metrics'] = 
        #  query['orderby'] = form_data.get('groupby')
        #  logging.info(self.json_dumps(query))
        #  TODO
        return query
